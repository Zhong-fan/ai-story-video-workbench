...
import NovelCreatePage from "./NovelCreatePage.vue";
...
const emit = defineEmits<{
  ...
  (e: "submit-feedback", value: { target_type: "series" | "arc" | "chapter"; target_id: number; feedback_text: string; feedback_type: string; priority: number }): void;
